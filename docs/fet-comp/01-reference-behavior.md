...
**DOCUMENTED** — [archive.org owner's manual](https://archive.org/stream/Urei_FETLN_owners_manual/Urei_FETLN_owners_manual_djvu.txt); [Wikipedia: FET Peak Limiter](https://en.wikipedia.org/wiki/FET_Peak_Limiter); knob-numbering direction also widely repeated in player literature, **FOLKLORE/ANECDOTAL** for the exact "why" but the direction itself is corroborated by the manual and by [Sterling Sky Sound: Know Your Gear](https://sterlingskyesound.com/blog/know-your-gear-FET-limiting-amplifier).

## Ratio settings and all-buttons-in

Four front-panel ratios: 4:1, 8:1, 12:1, 20:1, each engaging a different feedback/threshold network — switching ratio also shifts the effective threshold point (e.g., the manual gives roughly -24 dB ±2 dB input threshold at the 20:1 setting), so ratio is not independent of threshold in this topology. **DOCUMENTED** — [archive.org owner's manual](https://archive.org/stream/Urei_FETLN_owners_manual/Urei_FETLN_owners_manual_djvu.txt).
...
- **4:1 is the common choice even when slamming**, with depth set by the input control rather than the ratio switch — consistent with the no-threshold gain structure above. Tom Lord-Alge is reported to reach for one mainly on bass. **ANECDOTAL** — [JARP: All Buttons In](https://www.arpjournal.com/asarpwp/all-buttons-in-an-investigation-into-the-use-of-the-FET-compressor-in-popular-music-production/); [Sound On Sound: Inside Track: Tom Lord-Alge](https://www.soundonsound.com/techniques/inside-track-tom-lord-alge).
- **Revision preference splits by job, and the split is about distortion at depth.** The earliest non-low-noise units ("blue stripe") are favoured on lead vocals for an upper-mid "hair" that pushes a vocal forward; the later black-faced low-noise revisions are called smoother and cleaner. That change arrived around Rev C and is a circuit one: reduced drain-source voltage on the gain-reduction FET to hold it in its linear range, and a revised FET feedback network to minimise distortion. **ANECDOTAL** (preference), **DOCUMENTED** (circuit change) — [Gearspace: Rev A or Rev D](https://gearspace.com/threads/whats-the-difference-between-the-rev-a-or-rev-d-of-the-FET-compressors.380785/); [SonicScoop: FET vs FET vs FET](https://sonicscoop.com/FET-vs-FET-vs-FET-the-uad-plugin-models-face-off/).
...
Source: [archive.org: Urei FETLN Owner's Manual](https://archive.org/stream/Urei_FETLN_owners_manual/Urei_FETLN_owners_manual_djvu.txt); [Wikipedia: FET Peak Limiter](https://en.wikipedia.org/wiki/FET_Peak_Limiter); [JARP: All Buttons In (Moore, 2012)](https://www.arpjournal.com/asarpwp/all-buttons-in-an-investigation-into-the-use-of-the-FET-compressor-in-popular-music-production/); [Mix: FET Revision History](https://www.mixonline.com/recording/FET-revision-history-372048). Exact THD/noise/response figures vary slightly by revision and by which reprint of the manual is consulted; treat the table as target ballpark figures, not a single authoritative datasheet.
